<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PDFFormFields.aspx.cs" Inherits="demos_PDFFormFields" %>
...
<body class="finance">
    ...
    <div id="mainForm" runat="server" class="container-fixed formz-vertical">
        ...
        <ul class="nav nav-pills" role="tablist">
            ...
            <li class="active"><a href="PDFFormFields.aspx">PDF Form Fields</a></li>
        ...
        <form class="form-inline" runat="server" id="form">
            <div class="row">
                <div class="col-xs-12">
                    <h1><a id="PrefillClick" runat="server" href="#">PDF Form Fields Example</a></h1>
            ...
            <div class="row" id="primarySignerSection" runat="server">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <label for="MagicString">Field Pattern</label>
                        <input type="text" runat="server" class="form-control" id="signer1MagicPattern" placeholder="">
                    </div>
                    <hr />
                </div>
            ...
            <div class="row" id="jointSignerSection" runat="server">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <label for="MagicString">Field Pattern</label>
                        <input type="text" runat="server" class="form-control" id="signer2MagicPattern" placeholder="">
                    </div>
                    <hr />
                </div>
            </div>
