<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DynamicFields.aspx.cs" Inherits="DynamicFields" %>
...
<body class="finance">
    ...
    <div id="mainForm" runat="server" class="container-fixed formz-vertical">
        ...
        <form class="form-inline" runat="server" id="form">
            <div class="row">
                <div class="col-xs-12">
                    <h1><a id="PrefillClick" runat="server" href="#">Dynamic Fields Example</a></h1>
            ...
            <div class="row" id="tabInfo" runat="server">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <label for="tabName">Name</label>
                        <input type="text" runat="server" class="form-control" id="tabName2" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="page">Page</label>
                        <input type="text" runat="server" class="form-control" id="tabPage2" placeholder="">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="tabName">X Position</label>
                        <input type="text" runat="server" class="form-control" id="xPosition2" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="page">Y Position</label>
                        <input type="text" runat="server" class="form-control" id="yPosition2" placeholder="">
                    </div>
                    <hr />
                </div>
            </div>
